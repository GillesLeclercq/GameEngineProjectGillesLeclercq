  ...
  const bool is_material_seted)
{
  ...
  shape.mesh.faceIndices = faceIndices;
  ...
  MaterialReader& readMatFn)
{
  ...
  while (inStream.peek() != -1) {
    ...
    if (token[0] == 'f' && isSpace((token[1]))) {
	  ...
	  FaceIndices indices;
	  indices.s_vIndices3 = face[0].v_idx;
	  indices.s_vIndices2 = face[1].v_idx;
	  indices.s_vIndices1 = face[2].v_idx;

	  indices.s_tIndices3 = face[0].vt_idx;
	  indices.s_tIndices2 = face[1].vt_idx;
	  indices.s_tIndices1 = face[2].vt_idx;

	  indices.s_nIndices3 = face[0].vn_idx;
	  indices.s_nIndices2 = face[1].vn_idx;
	  indices.s_nIndices1 = face[2].vn_idx;
    ...
    if (token[0] == 'g' && isSpace((token[1]))) {
      ...
      shape_t shape;
      bool ret = exportFaceGroupToShape(shape, v, vn, vt, faceIndices, faceGroup, material, name, is_material_seted);
      if (ret) {
